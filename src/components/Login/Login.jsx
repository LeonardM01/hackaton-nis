  ...
  return (
    <div>
      ...
      <div className="grid">
        ...
        <p className="bottom-4 justify-self-center fixed text-center">Don't have and account? <span style={{ color: COLORS.primary }} onClick={onClickRegister}>Register now</span></p>
      </div>
    </div>
  );
}
