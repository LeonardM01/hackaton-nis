  ...
  return (
    <div>
      ...
      <div className="grid">
        ...
        <p className="static bottom-4 justify-self-center text-center">Don't have and account? <span style={{ color: COLORS.primary }} onClick={onClickRegister}>Register now</span></p>
      </div>
    </div>
  );
}
